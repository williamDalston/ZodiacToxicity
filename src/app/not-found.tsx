...
export const metadata: Metadata = {
  ...
  description: "This page doesn't exist. Head back to ZodiacToxicity and check your zodiac compatibility.",
};
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main id="main-content" className="relative z-10 flex flex-col items-center justify-center px-4 py-24 text-center">
        ...
        <h1
          className="text-5xl md:text-7xl font-black text-glow mb-4 font-display"
        >
          404
        </h1>
        ...
        <Link
          href="/"
          className="px-8 py-4 rounded-full text-lg font-bold bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white transition-all hover:shadow-[0_0_30px_rgba(139,92,246,0.4)] font-display"
        >
